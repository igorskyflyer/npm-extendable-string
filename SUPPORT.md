...
Hello, thank you for using ExtendableString! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-extendable-string/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-extendable-string/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-extendable-string/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - ExtendableString version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-extendable-string/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-extendable-string/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of ExtendableString:
...
<div align="center">
  Thank you for using ExtendableString!
  <br>
