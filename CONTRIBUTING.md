# 🫱🏼‍🫲🏼 Contributing to ExtendableString

Thank you for considering a contribution to ExtendableString! Whether you're fixing bugs, suggesting improvements, writing docs, or sharing ideas – your input helps the project grow and evolve.
...
- If you're unsure, feel free to open an [`issue`](https://github.com/igorskyflyer/npm-extendable-string/issues) or discussion to explore the idea.
...
Your contribution helps maintain and improve ExtendableString — thank you for helping make it better!  
Check out [`SUPPORT.md`](https://github.com/igorskyflyer/npm-extendable-string/blob/main/SUPPORT.md) if you need help or want to sponsor its development.
